...
<div>
	<a href="/articles" class="inline-flex items-center gap-1.5 text-sm text-slate-400 dark:text-zinc-500 hover:text-indigo-600 dark:hover:text-indigo-400 mb-12 transition-colors group">
